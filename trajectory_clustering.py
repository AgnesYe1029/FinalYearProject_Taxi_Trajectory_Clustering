...
class TrajectoryClustering:
    ...
    def trajectories_hdbscan(self, reshaped_trajectory_samples):
        hdb = hdbscan.HDBSCAN(min_cluster_size=8, gen_min_span_tree=True).fit(reshaped_trajectory_samples)
        labels = hdb.labels_
